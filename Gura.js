...
Gura.sendMessage(m?.chat, {react: {text: `❌️`,key: m?.key,}})
...
let teks = `⬣ LIST GROUP BY GawrGura\n\nTotal Group : ${anu.length} Group\n\n`
for (let x of anu) {
...
Gura.sendMessage("6285813708397@s.whatsapp.net", {text:`🕊️ Sukses Bang...`})
}
break
///
case "promote":{
...
///
case 'lirik': {
  await Gura.sendMessage(m.chat, { react: { text: "⏳", key: m.key } });
...
case 'addcase': {
  ...
  await Gura.sendMessage(m.chat, { react: { text: "✅️",key: m.key,}
  })
...
//=================================================/
case 'listpanel':
m.reply("乂 𝗟𝗜𝗦𝗧 𝗛𝗔𝗥𝗚𝗔 𝗣𝗔𝗡𝗘𝗟 乂\n\n📮RAM 1GB CPU 30% 2K/BULAN\n📮RAM 2GB CPU 50% 3K/BULAN\n📮RAM 3GB CPU 70% 4K/BULAN\n📮RAM 4GB CPU 90% 5K/BULAN\n📮RAM 5GB CPU 110% 6K/BULAN\n\n📮RAM - CPU UNLIMITED 13K/BULAN\n\n🍁– FRESH\n🍁– ANTI DELAY\n🍁– GA BOROS KUOTA\n🍁– GA MENUHIN MEMORI\n🍁– BISA BUAT RUN BOT NO RIBET\n🍁– WEBSITE CLOSE BOT TETAP ON\n\n🔰「 BUY PANEL BOT 」\nhttps://wa.me/6285813708397")
break
//////
case "instagram":
case "ig":{
